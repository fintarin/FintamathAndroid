...
public class KeyboardActionListenerMain implements KeyboardView.OnKeyboardActionListener {
    ...
    KeyboardActionListenerMain(Calculator calculator, KeyboardSwitcher keyboardSwitcher, EditText inText, TextView outText) {
